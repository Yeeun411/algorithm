...
class Solution {
    public int solution(int[][] jobs) {
        ...
        PriorityQueue<int[]> priorityQueue = new PriorityQueue<>((o1, o2) -> o1[1] - o2[1]); // 소요 시간이 짧은 작업 우선 처리
        ...
        while (count < jobs.length) {
            ...
            if (priorityQueue.isEmpty()) {
                ...
                total += time - job[0]; // 총 대기 시간 업데이트
                count++; // 처리된 작업 수 업데이트
            }
        }

        return total / jobs.length; // 평균 대기 시간 계산
    }
}